...
const  Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('portfolio_contact', 'portfolio_template', {from_name: form.name, to_name: 'Gael', from_email: form.email, to_email: 'gaelluntala@gmail.com', message: form.message,}, 'dFH6MRt-Unux95EiW' ).then(() => {
      setLoading(false);
